...
--
-- Host: 127.0.0.1    Database: warehouse_database
-- ------------------------------------------------------
...
CREATE TABLE `stores_items` (
  ...
  KEY `sid_idx` (`sid`),
  KEY `itemno_idx` (`itemno`),
  CONSTRAINT `itemno` FOREIGN KEY (`itemno`) REFERENCES `items` (`itemno`),
  CONSTRAINT `sid` FOREIGN KEY (`sid`) REFERENCES `stores` (`sid`)
...
-- Dump completed on 2022-10-14  5:47:00
